...
\begin{table}[H]
	...
	\end{tabular}
\end{table}
Um nun die zwei verschiedenen Zustände (\textit{lebendig}, \textit{tot}) anzuzeigen, sind verschiedene Darstellungen denkbar. Zum einen könnten tote Zellen mit Nullen und lebendige Zellen mit Einsen dargestellt werden. Denkbar wäre auch eine boolsche Darstellung \pythoninline{True} für lebendig und \pythoninline{False} für tot oder eine Darstellung mit Hilfe von Strings:\\
